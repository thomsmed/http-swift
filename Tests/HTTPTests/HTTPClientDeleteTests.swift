...
@Suite struct HTTPClientDeleteTests {
    @Test func testRequestDeleteEmptyRequestBodyEmptyResponseBody() async throws {
    ...
    @Test func testRequestDeleteEmptyRequestBodyNonEmptyResponseBody() async throws {
        let url = URL(string: "https://example.ios")!
        let session = MockSession()
    ...
    @Test func testRequestDeleteNonEmptyRequestBodyEmptyResponseBody() async throws {
        let url = URL(string: "https://example.ios")!
        let session = MockSession()
    ...
    @Test func testRequestDeleteNonEmptyRequestBodyNonEmptyResponseBody() async throws {
        let url = URL(string: "https://example.ios")!
        let decoder = JSONDecoder()
        let session = MockSession()
        let httpClient = HTTP.Client(
